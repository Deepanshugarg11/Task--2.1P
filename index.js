...
sgMail.setApiKey('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'); // SendGrid API key
...
app.post('/', async (req, res) => {
    ...
    const msg = {
        ...
        from: 'deepanshu4773.be23@chitkara.edu.in', // Your verified sender email
